...
export default function Footer() {
  return (
    <div className = "h-[30vh] bg-[#0d0a20] grid grid-cols-1 grid-rows-3 lg:grid-cols-3 lg:grid-rows-1 justify-between px-8 items-center">
      ...
      <div> 
        <img src='/src/assets/logo4.png' className= "min-w-24 w-24 inline-block md:hidden"/>
        <img src='/src/assets/logo3.png' className= "min-w-72 w-72 hidden md:inline-block"/>
      </div>
